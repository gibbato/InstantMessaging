...
var createFilter = function createFilter2(config) {
  return function(option2, rawInput) {
    if (option2.data.__isNew__) return true;
  ...
  return categorizedOptions.reduce(function(optionsAccumulator, categorizedOption) {
    if (categorizedOption.type === "group") {
      optionsAccumulator.push.apply(optionsAccumulator, _toConsumableArray(categorizedOption.options.map(function(option2) {
        return {
          data: option2.data,
          id: "".concat(optionId, "-").concat(categorizedOption.index, "-").concat(option2.index)
        };
      })));
    } else {
...
var getFocusedOptionId = function getFocusedOptionId2(focusableOptionsWithIds, focusedOption) {
  ...
  var focusedOptionId = (_focusableOptionsWith = focusableOptionsWithIds.find(function(option2) {
    return option2.data === focusedOption;
...
function _isOptionSelected(props, option2, selectValue) {
  if (selectValue.indexOf(option2) > -1) return true;
...
function _regeneratorRuntime() {
  ...
  function wrap(innerFn, outerFn, self, tryLocsList) {
    ...
    return generator._invoke = /* @__PURE__ */ function(innerFn2, self2, context2) {
    ...
    if (iterable) {
      ...
      if (!isNaN(iterable.length)) {
        var i = -1, next2 = function next3() {
          for (; ++i < iterable.length; ) if (hasOwn2.call(iterable, i)) return next3.value = iterable[i], next3.done = false, next3;
  ...
  return GeneratorFunction.prototype = GeneratorFunctionPrototype, define(Gp, "constructor", GeneratorFunctionPrototype), define(GeneratorFunctionPrototype, "constructor", GeneratorFunction), GeneratorFunction.displayName = define(GeneratorFunctionPrototype, toStringTagSymbol, "GeneratorFunction"), exports.isGeneratorFunction = function(genFun) {
    ...
    reset: function(skipTempReset) {
      if (this.prev = 0, this.next = 0, this.sent = this._sent = void 0, this.done = false, this.delegate = null, this.method = "next", this.arg = void 0, this.tryEntries.forEach(resetTryEntry), !skipTempReset) for (var name in this) "t" === name.charAt(0) && hasOwn2.call(this, name) && !isNaN(+name.slice(1)) && (this[name] = void 0);
    },
    stop: function() {
      this.done = true;
...
var ChatHeader = function ChatHeader2(props) {
  ...
  if (!otherMember || !props.chat) return import_react10.default.createElement("div", {
...
var CustomChatCard = function CustomChatCard2(props) {
  var chat = props.chat;
  if (chat === void 0) return import_react10.default.createElement("div", null);
